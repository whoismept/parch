...
apps=("git" "xorg-server" "lightdm" "lightdm-pantheon-greeter" "gala" "plank" "wingpanel" "pantheon-applications-menu"
    ...
    "switchboard-plug-network" "switchboard-plug-notifications" "switchboard-plug-online-accounts" "switchboard-plug-parental-controls"
    "switchboard-plug-power" "switchboard-plug-printers" "switchboard-plug-security-privacy" "switchboard-plug-sharing",
    "switchboard-plug-sound" "switchboard-plug-user-accounts" "switchboard-plug-wacom" "pantheon-calculator" "pantheon-calendar" 
    "pantheon-camera" "pantheon-code" "pantheon-files" "pantheon-mail" "pantheon-music" "pantheon-photos" "pantheon-screenshot"
